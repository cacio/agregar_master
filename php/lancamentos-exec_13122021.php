						...
						foreach($xml2->NFe->infNFe->det as $prod2){
							...
							if($numrl > 0){
								...
								if($tipo == 'E'){
										...
										'codigo'=>''.trim($prod2->prod->cProd).'',
										'cnota'=>''.trim($xml2->NFe->infNFe->ide->nNF).'',
										'msg'=>' Código do produto ('.trim($prod2->prod->cProd).' '.$prod2->prod->xProd.') ::  Produto relacionado com código do AGREGAR de entradas, em documento de saída. Verifique o relacionamento!::',
										"dados"=> array(
												'nNF'=>''.$xml2->NFe->infNFe->ide->nNF.'',
												'entsai'=>'Saida',
												'cliente'=>''.$xml2->NFe->infNFe->dest->xNome.'',
